...
import com.dgmarkt10r.context.NewCustomer;
...
public class RegistrationFormSteps {
    ...
    public void fillsInAllFieldsOfTheRegistrationFormWithValidData() {
        ...
        registerAccountForm.fieldFirstNameRegistrationForm.sendKeys(newCustomer.firstName);
        registerAccountForm.fieldLastNameRegistrationForm.sendKeys(newCustomer.lastName);
        registerAccountForm.fieldEMailRegistrationForm.sendKeys(newCustomer.email);
        registerAccountForm.fieldTelephoneRegistrationForm.sendKeys(newCustomer.telephone);
        registerAccountForm.fieldPasswordRegistrationForm.sendKeys(newCustomer.password);
        registerAccountForm.fieldPasswordConfirmRegistrationForm.sendKeys(newCustomer.password);
